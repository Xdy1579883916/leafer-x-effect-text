...
@registerUI()
export class EffectText<TConstructorData = ITextInputData> extends UI<TConstructorData> implements IText {
  public get __tag() {
    return 'EffectText'
  }
  ...
  override __updateBoxBounds(): void {
    ...
    if (italic)
      b.width += fontSize * 0.16 // 倾斜会导致文本的bounds增大
